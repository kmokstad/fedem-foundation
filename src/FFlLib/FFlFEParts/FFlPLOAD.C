...
{
  FFlSURFLOADTypeInfoSpec::instance()->setTypeName("SURFLOAD");
  FFlSURFLOADTypeInfoSpec::instance()->setCathegory(FFlTypeInfoSpec::LOAD);

  FFlSURFLOADAttributeSpec::instance()->addLegalAttribute("PORIENT", false);

  LoadFactory::instance()->registerCreator
    (FFlSURFLOADTypeInfoSpec::instance()->getTypeName(),
...
{
  FFlFACELOADTypeInfoSpec::instance()->setTypeName("FACELOAD");
  FFlFACELOADTypeInfoSpec::instance()->setCathegory(FFlTypeInfoSpec::LOAD);

  FFlFACELOADAttributeSpec::instance()->addLegalAttribute("PORIENT", false);
